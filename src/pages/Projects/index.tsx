...
const ProjectPage = () => {
  return (
    <div className="bg-gray-100 page-wrapper flex flex-col items-center justify-center p-20">
      <div className="bg-white rounded-md shadow-xl p-8 min-h-140 min-w-180 max-w-200 flex flex-col items-start justify-start">
