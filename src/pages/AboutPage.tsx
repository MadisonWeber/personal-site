    ...
    <div className="page-wrapper bg-gray-100 flex flex-col items-center justify-center">
      <div className="relative">
        ...
        <div
          ...
          } delay-100 duration-500 relative p-4 sm:p-6 md:p-8 min-h-110 w-[96vw] md:w-180 shadow-xl bg-white rounded-md flex flex-col items-start justify-start`}
        >
          <div className="flex flex-col-reverse sm:flex-row gap-8 items-start justify-start w-full">
            <div className="flex-1 h-full w-full flex flex-col grow items-start justify-start bg-gray-100 flex-wrap max-h-100  shadow-lg rounded-xl p-2.5 gap-y-2.5">
